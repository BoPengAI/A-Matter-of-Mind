...
5. IF $$\mathbb{I}$$ is much smarter than $$\mathbb{A}$$, written as $$\mathbb{I}>>\mathbb{A}$$, then $$\mathbb{I}$$ should have little trouble predicting $$\mathbb{A}$$'s behavior, arriving at a low $$AIM_{\mathbb{A}|\mathbb{I}}$$ value.
